...
[More information on Web Access Control](https://www.w3.org/wiki/WebAccessControl).
...
A client or server may wish to push a notification to a second client or server that the latter has not explicitly requested.
